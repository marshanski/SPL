...
bin/cRace: bin/main.o  bin/Agent.o bin/Coalition.o bin/Graph.o bin/Parser.o bin/Party.o SelectionPolicy.o bin/Simulation.o 
	g++ -o bin/cRace bin/main.o  bin/Agent.o bin/Coalition.o bin/Graph.o bin/Parser.o bin/Party.o SelectionPolicy.o bin/Simulation.o 
