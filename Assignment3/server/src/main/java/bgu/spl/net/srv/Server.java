...
public interface Server<T> extends Closeable {
     ...
     */
    public static <T> Server<T>  threadPerClient(int port,Supplier<StompProtocol<T> > protocolFactory,Supplier<StompMessageEncoderDecoder<T>> encoderDecoderFactory)
    {
